                        ...
                        <ul id="sidebar-main" class="nav">
                            ...
                            <li><a href="#"><i class="icon-note"></i><span class="menu-title">Add</span><span
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li><a href="cabservice.jsp"><span class="submenu-title">Cab Service</span></a></li>
                                </ul>
                            </li>
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            <div id="viewcode-advance-form-script" class="viewcode-example">
                                                <form id="advance-form" method="post" class="form-horizontal" action="/cabserviceHS/employee/add" commandName="employee">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <select name="usertype" class="form-control">
                                                                ...
                                                                <option value="projectmanager">Project Maneger</option>
