                    ...
                    <div class="content">
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="caption">View All Receipt</div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="caption">View All Receipt Details</div>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row mbm">
                                            <div class="col-md12">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="table_id"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>hfgsdhfbdhb</td>
                                                                <td><span
                                                                        class="label label-sm label-success">Approved</span>
                                                                </td>
                                                                 <td>budjet</td>
                                                                 <td>750</td>
                                                                <td>
