...
<div class="page-form">
    <form action="http://next-themes.com/mtek/code/index.html" class="form">
        ...
        <div class="header-content text-center"><h1><p class="text-muted">User Profile</p></h1></div>
		...
		<div class="list-group-item"><input name="u_password" type="text" placeholder="Confirm password" class="form-control"></div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="text-center btn btn-success btn-circle btn-block btn-shadow">Edit User Profile
                    </button>
                </div>
            </div>
            <div class="clearfix"></div>
