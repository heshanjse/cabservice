...
public class ProjectDaoImpl implements ProjectDAO{
    ...
    public Collection getEmployeesbyType(String Type){
        return this.sessionFactory.getCurrentSession().createQuery("FROM Employee where Employee.usertype=?").setParameter(0,Type).list();
